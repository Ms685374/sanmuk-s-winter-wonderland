    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="glass-morphism rounded-full px-4 md:px-6 py-3 flex items-center justify-between">
          ...
          >
            <motion.div 
              className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center shadow-lg"
          ...
          <div className="hidden md:flex items-center gap-1">
            {navItems.map((item, index) => (
              ...
              >
                {item.name}
                <motion.div 
                  className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1 h-1 bg-primary rounded-full opacity-0 group-hover:opacity-100"
          ...
          >
            <span className="hidden sm:inline">Open Gift</span>
