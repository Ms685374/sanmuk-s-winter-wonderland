...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Floating orbs */}
      <motion.div 
        className="floating-orb w-96 h-96 bg-primary/20 top-20 -right-20"
        style={{ y }}
      />
      <motion.div 
        className="floating-orb w-72 h-72 bg-accent/20 bottom-40 -left-20"
      ...
      >
        ...
        <div className="relative mb-8">
          ...
          <motion.img
            ...
            className="absolute -right-10 md:right-10 lg:right-32 top-1/2 -translate-y-1/2 w-32 md:w-48 lg:w-64 animate-float-gentle glow-accent"
          />
        </div>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-muted-foreground max-w-lg mx-auto mb-16 font-light"
        >
          A love story between 
          <span className="text-primary font-medium"> Zubi </span>
          & 
          <span className="text-primary font-medium"> Zuro</span>
        </motion.p>
        ...
        >
          ...
          <motion.img
            src={glassHeart}
            alt="Crystal Heart"
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] opacity-30 blur-sm"
          ...
          <motion.img
            src={couple3d}
            alt="Zubi & Zuro"
            className="relative z-10 w-64 md:w-80 lg:w-96 drop-shadow-2xl mx-auto"
            animate={{ y: [0, -15, 0] }}
